...
- [📖 React Front-End ](#-react-front-end-)
  ...
  - [🔗 Link To Hello Rails Back-End ](#-link-to-hello-rails-back-end-)
...
**React Front-End** a simple app react igenerate random greeting.
...
```bash
  git clone https://github.com/AlselwiAisha/hello-react-front-end.git
```
### Install
...
Feel free to check the [issues page](https://github.com/AlselwiAisha/hello-react-front-end/issues/).
